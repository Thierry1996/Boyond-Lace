...
const RAW: [string, number, number, keyof typeof HREF, boolean?][] = [
  ...
  ["Invisi Draw-strings Deep Wave 13x6 HD Full Lace Frontal Wear Go Wig", 169.9, 229.9, "hdlace", true],
  ["Invisi Draw-strings Burmese Curly 13x6 HD Full Lace Frontal Wear Go Wig", 172.9, 234.9, "hdlace"],
  ["M-Cap 9x6 Pre-Cut HD Lace Pre-Plucked Kinky Curly Wear Go Glueless Wig", 145.9, 210.0, "glueless"],
  ...
  ["Highlight Brown 360 Pre-Cut Lace InvisiFit Water Wave Wear Go Glueless Wig", 179.9, 249.9, "highlight"],
